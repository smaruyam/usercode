# /users/smaruyam/Run2dev/myRun2/V35 (CMSSW_7_4_13)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/smaruyam/Run2dev/myRun2/V35')
)
...
process.hltPreEle15IsoVVVLDiPFJet40DEta3p5MJJ750HTT350PFMETNoMu60JetIdCleaned = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPreDiPFJet40DEta3p5MJJ600PFMETNoMu140JetIdCleaned = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.hltPrePFHT350PFMET100JetIdCleaned = cms.EDFilter( "HLTPrescaler",
    L1GtReadoutRecordTag = cms.InputTag( "hltGtDigis" ),
    offset = cms.uint32( 0 )
)
...
process.HLT_Ele15_IsoVVVL_DiPFJet40_DEta3p5_MJJ750_HTT350_PFMETNoMu60_JetIdCleaned_v1 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT150ORHTT175ORHTT200 + process.hltPreEle15IsoVVVLDiPFJet40DEta3p5MJJ750HTT350PFMETNoMu60JetIdCleaned + cms.ignore(process.hltL1sL1SingleEG5Open) + process.HLTRecoMETSequence + process.hltMET20 + process.HLTAK4CaloJetsSequence + process.hltMetCleanUsingJetID + process.hltMETCleanUsingJetID20 + process.hltDiCaloJet20MJJ400DEta3p5 + process.HLTEle15VVVLGsfSequence + process.HLTAK4PFJetsSequence + process.hltDiPFJet40MJJ750DEta3p5 + process.hltPFHT + process.hltPFHT350 + process.hltPFMETNoMuProducer + process.hltPFMETNoMu60 + process.HLTEndSequence )
process.HLT_DiPFJet40_DEta3p5_MJJ600_PFMETNoMu140_JetIdCleaned_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1ETM60ORETM70 + process.hltPreDiPFJet40DEta3p5MJJ600PFMETNoMu140JetIdCleaned + process.HLTRecoMETSequence + process.hltMET80 + process.HLTAK4CaloJetsSequence + process.hltMetCleanUsingJetID + process.hltMETCleanUsingJetID80 + process.hltDiCaloJet30MJJ500DEta3p0 + process.HLTAK4PFJetsSequence + process.hltDiPFJet40MJJ600DEta3p5 + process.hltPFMETNoMuProducer + process.hltPFMETNoMu140 + process.HLTEndSequence )
process.HLT_Ele15_IsoVVVL_PFHT600_v3 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT100ORL1HTT125ORL1HTT150ORHTT175 + process.hltPreEle15IsoVVVLPFHT600 + cms.ignore(process.hltL1sL1SingleEG5Open) + process.HLTAK4CaloJetsSequence + process.hltHtMht + process.hltHT200 + process.HLTEle15VVVLGsfSequence + process.HLTAK4PFJetsSequence + process.hltPFHT + process.hltPFHT600 + process.HLTEndSequence )
process.HLT_PFHT350_PFMET100_JetIdCleaned_v2 = cms.Path( process.HLTBeginSequence + process.hltL1sL1HTT100ORL1HTT125ORL1HTT150ORHTT175 + process.hltPrePFHT350PFMET100JetIdCleaned + process.HLTRecoMETSequence + process.hltMET75 + process.HLTAK4CaloJetsSequence + process.hltMetCleanUsingJetID + process.hltMETCleanUsingJetID70 + process.hltHtMht + process.hltHT280 + process.HLTAK4PFJetsSequence + process.hltPFMETProducer + process.hltPFMET100Filter + process.hltPFHT + process.hltPFHT350 + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Ele15_IsoVVVL_DiPFJet40_DEta3p5_MJJ750_HTT350_PFMETNoMu60_JetIdCleaned_v1, process.HLT_DiPFJet40_DEta3p5_MJJ600_PFMETNoMu140_JetIdCleaned_v2, process.HLT_Ele15_IsoVVVL_PFHT600_v3, process.HLT_PFHT350_PFMET100_JetIdCleaned_v2, process.HLTriggerFinalPath ))
...
if hasattr(process, 'hltCaloStage1Digis'):
    ...
    process.hltCaloStage1Digis.FWOverride = cms.bool(True)
...
_customInfo['globalTags'][False] = "74X_HLT_mcRun2_asymptotic_fromSpring15DR_v0"
_customInfo['inputFiles']={}
_customInfo['inputFiles'][True]  = "file:RelVal_Raw_GRun_DATA.root"
#_customInfo['inputFiles'][False] = "file:RelVal_Raw_GRun_MC.root"
_customInfo['inputFiles'][False] = "/store/mc/Phys14DR/WToENu_Tune4C_13TeV-pythia8/GEN-SIM-RAW/AVE20BX25_tsg_PHYS14_25_V3-v1/20000/00B071C8-808B-E411-84A8-F04DA275C328.root"
...
_customInfo['inputFile'] = "/store/mc/RunIISpring15Digi74/WJetsToLNu_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8/GEN-SIM-RAW/AVE40BX25nstsg_MCRUN2_74_V7-v1/70000/08AEA956-DAFB-E411-B995-E0CB4E19F969.root"
#_customInfo['inputFile'] = "/store/mc/Phys14DR/WToENu_Tune4C_13TeV-pythia8/GEN-SIM-RAW/AVE20BX25_tsg_PHYS14_25_V3-v1/20000/00B071C8-808B-E411-84A8-F04DA275C328.root"
...
process.vbftrig = cms.EDAnalyzer("VBFtrig",
    ...
    triggerName1 = cms.untracked.string("HLT_Ele15_IsoVVVL_DiPFJet40_DEta3p5_MJJ750_HTT350_PFMETNoMu60_JetIdCleaned_v1"),
    triggerName2 = cms.untracked.string("HLT_PFHT350_PFMET100_JetIdCleaned_v2"),
    triggerName3 = cms.untracked.string("HLT_DiPFJet40_DEta3p5_MJJ600_PFMETNoMu140_JetIdCleaned_v2"),
    triggerL1Name = cms.untracked.string("hltL1sL1HTT150ORHTT175ORHTT200"),
    triggerL3LeptonName1 = cms.untracked.string("hltEle15VVVLClusterShapeFilter"),
    triggerL3LeptonName2 = cms.untracked.string("hltEle15VVVLGsfDphiFilter"),
    triggerL3LeptonName3 = cms.untracked.string("hltEle15VVVLGsfTrackIsoFilter"),
